...
class AppearancesControllerTest < ActionController::TestCase
  ...
  test "should create appearance" do
    assert_difference('Appearance.count') do
      post :create, appearance: { date: @appearance.date, end: @appearance.end, guest: @appearance.guest, host: @appearance.host, network: @appearance.network, show: @appearance.show, start: @appearance.start, topic: @appearance.topic }
    end
  ...
  test "should update appearance" do
    put :update, id: @appearance, appearance: { date: @appearance.date, end: @appearance.end, guest: @appearance.guest, host: @appearance.host, network: @appearance.network, show: @appearance.show, start: @appearance.start, topic: @appearance.topic }
    assert_redirected_to appearance_path(assigns(:appearance))
  end
